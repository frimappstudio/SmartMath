...
public class Materi59testActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi059test);
                ...
                if (soalbenar-soalsalah>7 && soaldijawab>7){
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya!", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    final Intent i = new Intent(getApplicationContext(), Materi60Activity.class);
                                    startActivity(i);
                                    finish();
                                }
                            })
