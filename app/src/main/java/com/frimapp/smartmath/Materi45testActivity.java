...
public class Materi45testActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi045test);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
        alertDialogBuilder.setTitle("Mulai Tes");
        alertDialogBuilder
                .setMessage("Anda sudah menyatakan paham. Kami akan mengetest anda hingga 3 menit.")
                .setCancelable(false)
    ...
    public void Timerstart() {
        ...
        new CountDownTimer(180000, 500) { // adjust the milli seconds here
            ...
            public void onFinish() {
                ...
                if (soalbenar-soalsalah>8 && soaldijawab>8){
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Oke!", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    final Intent i = new Intent(getApplicationContext(), Materi46Activity.class);
                                    startActivity(i);
                                    finish();
                                }
                            })
    ...
    public void generate() {
        if (sudahdijawab==0) {
            Random r = new Random();
            int pertama = r.nextInt(30 - 1) + 1;
            int kedua = r.nextInt(30 - 1) + 1;
            int ketiga = r.nextInt(30 - 1) + 1;
            ...
            TextView textsoal2 = (TextView) findViewById(R.id.textView9);
            textsoal2.setText(keduas);
            String ketigas = Integer.toString(kedua);
            TextView textsoal3 = (TextView) findViewById(R.id.textView10);
            textsoal2.setText(ketigas);
            Random s = new Random();
