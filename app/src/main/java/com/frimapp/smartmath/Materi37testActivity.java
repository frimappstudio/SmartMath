...
public class Materi37testActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi037test);
                ...
                if (soalbenar-soalsalah>7 && soaldijawab>7){
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Ya!", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    final Intent i = new Intent(getApplicationContext(), Materi38Activity.class);
                                    startActivity(i);
                                    finish();
                                }
                            })
