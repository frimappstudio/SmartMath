...
public class Materi57testActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi057test);
            ...
            public void onFinish() {
                ...
                if (soalbenar-soalsalah>4 && soaldijawab>4){
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Oke!", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    final Intent i = new Intent(getApplicationContext(), Materi58Activity.class);
                                    startActivity(i);
                                    finish();
                                }
                            })
