...
public class Materi1testActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi001test);
    ...
    public void Timerstart() {
        ...
        new CountDownTimer(10000, 1000) { // adjust the milli seconds here
            ...
            public void onFinish() {
               ...
               if (soalbenar-soalsalah>10 && soaldijawab>10){
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
                alertDialogBuilder.setTitle("WAKTU HABIS");
                alertDialogBuilder
                        .setMessage("Selamat! Anda telah berhasil melakukan tes. Anda telah menjawab " + soaldijawab + " soal, dan mampu menjawab " + soalbenar + " soal dengan benar. Anda menjawab dengan tidak benar sebanyak " + soalsalah + " soal. Skor anda adalah " + (soaldijawab-soalsalah) + ". Koin bertambah sebesar "+ ((soaldijawab-soalsalah)*1) + " Apakah anda ingin lanjut ke materi tingkat selanjutnya?.")
                        .setCancelable(false)
                        .setPositiveButton("Ya!", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                final Intent i = new Intent(getApplicationContext(), Materi2Activity.class);
                                startActivity(i);
                            }
                        })
            ...
            if ((soalbenar-soalsalah)<10 || soaldijawab<10){
                kowin = Integer.parseInt(Koin);
                int tambahkoin = ((soalbenar-soalsalah)*1);
                if (tambahkoin > 0) {
                    int koinjadi = kowin + tambahkoin;
                    String koen = Integer.toString(koinjadi);
                    mKoin.setValue(koen);
                }
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
                alertDialogBuilder.setTitle("WAKTU HABIS");
                alertDialogBuilder
                        .setMessage("Anda telah gagal lulus tes. Anda telah menjawab " + soaldijawab + " soal, dan mampu menjawab " + soalbenar + " soal dengan benar. Anda menjawab dengan tidak benar sebanyak " + soalsalah + " soal. Skor anda adalah " + (soalbenar-soalsalah) + ". Koin bertambah sebesar " + ((soalbenar-soalsalah)*1) + ". Apakah anda ingin berlatih lagi?")
                        .setCancelable(false)
                        .setPositiveButton("Ya!", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
