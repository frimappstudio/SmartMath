...
public class Materi43testActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi043test);
            ...
            public void onFinish() {
                ...
                if (soalbenar-soalsalah>8 && soaldijawab>8){
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Oke!", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    final Intent i = new Intent(getApplicationContext(), Materi42Activity.class);
                                    startActivity(i);
                                    finish();
                                }
                            })
