...
public class Materi39testActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi039test);
            ...
            public void onFinish() {
                ...
                if (soalbenar-soalsalah>4 && soaldijawab>4){
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Oke!", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    final Intent i = new Intent(getApplicationContext(), Materi40Activity.class);
                                    startActivity(i);
                                    finish();
                                }
                            })
