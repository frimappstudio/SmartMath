...
public class Materi64testActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi64test);
        ...
        alertDialogBuilder
                ...
                .setNegativeButton("Tidak, saya belum paham.", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        final Intent i = new Intent(getApplicationContext(), Materi64Activity.class);
                        startActivity(i);
                        finish();
                    }
                });
    ...
    public void generate() {
        if (sudahdijawab==0) {
            ...
            ketiga = r.nextInt(30 - 4) + 1;
            Hasil = ((pertama*(kedua+ketiga))/2);
            String pertamas = Integer.toString(pertama);
            String keduas = Integer.toString(kedua);
            String ketigas = Integer.toString(ketiga);
            ...
            TextView textsoal3 = (TextView) findViewById(R.id.textView7);
