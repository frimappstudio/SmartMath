...
public class Materi44testActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi044test);
        ...
        alertDialogBuilder
                ...
                .setNegativeButton("Tidak, saya belum paham.", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        final Intent i = new Intent(getApplicationContext(), Materi44Activity.class);
                        startActivity(i);
                        finish();
                    }
                });
