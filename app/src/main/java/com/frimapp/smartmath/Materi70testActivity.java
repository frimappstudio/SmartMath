...
public class Materi70testActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi70test);

        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
        alertDialogBuilder.setTitle("Mulai Tes");
        alertDialogBuilder
                .setMessage("Anda sudah menyatakan paham. Kami akan mengetest anda hingga 5 menit.")
                .setCancelable(false)
                ...
                .setNegativeButton("Tidak, saya belum paham.", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        final Intent i = new Intent(getApplicationContext(), Materi70Activity.class);
                        startActivity(i);
                        finish();
                    }
                });
    ...
    public void Timerstart() {
        ...
        new CountDownTimer(300000, 500) { // adjust the milli seconds here
                ...
                if (soalbenar-soalsalah>4 && soaldijawab>4){
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Mantap!", new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int id) {
                                    final Intent i = new Intent(getApplicationContext(), Materi71Activity.class);
                                    startActivity(i);
                                    finish();
                                }
                            });
    ...
    public void generate() {
        if (sudahdijawab==0) {
            Random r = new Random();
            pertama = r.nextInt(30 - 4) + 4;
            Hasil = (6*(pertama*pertama));
