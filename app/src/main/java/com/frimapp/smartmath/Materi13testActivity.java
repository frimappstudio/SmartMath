...
public class Materi13testActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi013test);
    ...
    public void generate() {
        if (sudahdijawab==0) {
            Random r = new Random();
            int pertama = r.nextInt(50 - 1) + 1;
            Random z = new Random();
            int kedua = z.nextInt(50 - 1) + 1;
            float Hasilas=(pertama / kedua);
            Hasil = (int)Hasilas;
            while (pertama % kedua != 0 || pertama == 1 || kedua == 1) {
                Random s = new Random();
                pertama = s.nextInt(50 - 1) + 1;
                Random y = new Random();
                kedua = y.nextInt(50 - 1) + 1;
                Hasilas=(pertama / kedua);
                Hasil = (int)Hasilas;
            }
            ...
            if (jawaban==1) {
                ...
                Random b = new Random();
                int jawabanb = b.nextInt(50 - 1) + 1;
                Random c = new Random();
                int jawabanc = c.nextInt(50 - 1) + 1;
                while((jawabanb== jawabanc) || (jawabanb==Hasil) || (jawabanc==Hasil)){
                    Random e = new Random();
                    jawabanb = e.nextInt(50 - 1) + 1;
                    Random f = new Random();
                    jawabanc = f.nextInt(50 - 1) + 1;
                }
                Random d = new Random();
                int jawaband = d.nextInt(50 - 1) + 1;
                while ((jawabanb==jawaband) || (jawabanc==jawaband) || (Hasil==jawaband)) {
                    Random g = new Random();
                    jawaband = g.nextInt(50 - 1) + 1;
                }
            ...
            if (jawaban==2) {
                ...
                Random a = new Random();
                int jawabana = a.nextInt(50 - 1) + 1;
                Random c = new Random();
                int jawabanc = c.nextInt(50 - 1) + 1;
                while((jawabana== jawabanc) || (jawabana==Hasil) || (jawabanc==Hasil)){
                    Random e = new Random();
                    jawabana = e.nextInt(50 - 1) + 1;
                    Random f = new Random();
                    jawabanc = f.nextInt(50 - 1) + 1;
                }
                Random d = new Random();
