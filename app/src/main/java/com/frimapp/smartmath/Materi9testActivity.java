...
public class Materi9testActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi009test);
    ...
    public void generate() {
        if (sudahdijawab==0) {
            Random r = new Random();
            int pertama = r.nextInt(10 - 1) + 1;
            Random z = new Random();
            int kedua = z.nextInt(10 - 1) + 1;
            Hasil=(pertama * kedua);
            String pertamas = Integer.toString(pertama);
            String keduas = Integer.toString(kedua);
            String soal = pertamas + " x " + keduas + " = " + " " + "...";
            ...
            if (jawaban==1) {
                ...
                Random b = new Random();
                int jawabanb = b.nextInt(100 - 1) + 1;
                Random c = new Random();
                int jawabanc = c.nextInt(100 - 1) + 1;
                while((jawabanb== jawabanc) || (jawabanb==Hasil) || (jawabanc==Hasil)){
                    Random e = new Random();
                    jawabanb = e.nextInt(100 - 1) + 1;
                    Random f = new Random();
                    jawabanc = f.nextInt(100 - 1) + 1;
                }
                Random d = new Random();
                int jawaband = d.nextInt(100 - 1) + 1;
            ...
            if (jawaban==2) {
                ...
                Random a = new Random();
                int jawabana = a.nextInt(100 - 1) + 1;
                Random c = new Random();
                int jawabanc = c.nextInt(100 - 1) + 1;
                while((jawabana== jawabanc) || (jawabana==Hasil) || (jawabanc==Hasil)){
                    Random e = new Random();
                    jawabana = e.nextInt(100 - 1) + 1;
                    Random f = new Random();
                    jawabanc = f.nextInt(100 - 1) + 1;
                }
                Random d = new Random();
