...
public class Materi2testActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materi002test);
    ...
    public void Timerstart() {
        ...
        new CountDownTimer(60000, 1000) { // adjust the milli seconds here
            ...
            public void onFinish() {
                ...
                if ((soalbenar-soalsalah)>7 && soaldijawab>7){
                    AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(context);
    ...
    public void generate() {
        if (sudahdijawab==0) {
            Random r = new Random();
            int pertama = r.nextInt(999 - 1) + 1;
            Random z = new Random();
            int kedua = z.nextInt(999 - 1) + 1;
            Hasil=(pertama + kedua);
            while (999 < Hasil) {
                Random x = new Random();
                pertama = x.nextInt(999 - 1) + 1;
                Random y = new Random();
                kedua = y.nextInt(999 - 1) + 1;
                Hasil=(pertama + kedua);
            }
            ...
            if (jawaban==1) {
                ...
                Random b = new Random();
                int jawabanb = b.nextInt(999 - 1) + 1;
                Random c = new Random();
                int jawabanc = c.nextInt(999 - 1) + 1;
                while((jawabanb== jawabanc) || (jawabanb==Hasil) || (jawabanc==Hasil)){
                    Random e = new Random();
                    jawabanb = e.nextInt(999 - 1) + 1;
                    Random f = new Random();
                    jawabanc = f.nextInt(999 - 1) + 1;
                }
                Random d = new Random();
                int jawaband = d.nextInt(999 - 1) + 1;
                while ((jawabanb==jawaband) || (jawabanc==jawaband) || (Hasil==jawaband)) {
                    Random g = new Random();
                    jawaband = g.nextInt(999 - 1) + 1;
                }
            ...
            if (jawaban==2) {
                ...
                Random a = new Random();
                int jawabana = a.nextInt(999 - 1) + 1;
                Random c = new Random();
                int jawabanc = c.nextInt(999 - 1) + 1;
                while((jawabana== jawabanc) || (jawabana==Hasil) || (jawabanc==Hasil)){
                    Random e = new Random();
                    jawabana = e.nextInt(999 - 1) + 1;
                    Random f = new Random();
                    jawabanc = f.nextInt(999 - 1) + 1;
                }
                Random d = new Random();
